...
sudo service unicorn_Shaseng <start|stop|restart>
sudo service sidekiq_Shaseng <start|stop>
```
...
```
/home/deployer/apps/Shaseng/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_Shaseng restart
sudo service sidekiq_Shaseng stop
sudo service sidekiq_Shaseng start
```
